...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.1.3/css/bootstrap.min.css" integrity="sha384-MCw98/SFnGE8fJT3GXwEOngsV7Zt27NXFoaoApmYm81iuXoPkFOJwJ8ERdknLPMO" crossorigin="anonymous">
				<title>customerphones</title>
				</head>
		 <body style="background-color: black;margin:0">
		<h1><center><font color="purple"><div class="card text-white bg-dark mb-3" style="max-width: 100rem;">
			<div class="card-header"><b><font color="orange">CUSTOMER DATABASE</font></b>
			<p>		<center><div class="card text-white bg-danger mb-3" style="max-width: 50rem;">
			<div class="card-body">
		<h5 class="card-title"><form method="POST" action="cstomerdb.jsp">
